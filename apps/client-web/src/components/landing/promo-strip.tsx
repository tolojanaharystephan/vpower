...
export async function PromoStrip() {
  ...
  return (
    <section className="relative overflow-hidden border-y border-[rgba(245,240,232,0.08)] bg-[rgba(18,16,12,0.65)]">
      <div
        className="pointer-events-none absolute -right-16 top-0 h-48 w-48 rounded-full bg-[rgba(46,163,242,0.1)] blur-3xl"
        aria-hidden
      />
      <div className="relative mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid gap-5 md:grid-cols-2">
          <div className="promo-panel cinema-panel p-5 transition duration-300 hover:border-[rgba(46,163,242,0.35)]">
